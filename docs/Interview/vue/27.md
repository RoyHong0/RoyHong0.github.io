...
![img](https://static.vue-js.com/b6cd6a60-4aba-11eb-ab90-d9ae814b240d.png)

## [#](https://vue3js.cn/interview/vue/structure.html#一、为什么要划分)一、为什么要划分
...
### [#](https://vue3js.cn/interview/vue/structure.html#文件夹和文件夹内部文件的语义一致性)文件夹和文件夹内部文件的语义一致性
...
### [#](https://vue3js.cn/interview/vue/structure.html#单一入口-出口)单一入口/出口
...
### [#](https://vue3js.cn/interview/vue/structure.html#就近原则-紧耦合的文件应该放到一起-且应以相对路径引用)就近原则，紧耦合的文件应该放到一起，且应以相对路径引用
...
### [#](https://vue3js.cn/interview/vue/structure.html#公共的文件应该以绝对路径的方式从根目录引用)公共的文件应该以绝对路径的方式从根目录引用
...
### [#](https://vue3js.cn/interview/vue/structure.html#src-外的文件不应该被引入)/src 外的文件不应该被引入

`vue-cli`脚手架已经帮我们做了相关的约束了，正常我们的前端项目都会有个`src`文件夹，里面放着所有的项目需要的资源，`js`,`css`, `png`, `svg` 等等。`src` 外会放一些项目配置，依赖，环境等文件

这样的好处是方便划分项目代码文件和配置文件

## [#](https://vue3js.cn/interview/vue/structure.html#二、目录结构)二、目录结构
...
### [#](https://vue3js.cn/interview/vue/structure.html#小结)小结

项目的目录结构很重要，因为目录结构能体现很多东西，怎么规划目录结构可能每个人有自己的理解，但是按照一定的规范去进行目录的设计，能让项目整个架构看起来更为简洁，更加易用

## [#](https://vue3js.cn/interview/vue/structure.html#参考文献)参考文献
