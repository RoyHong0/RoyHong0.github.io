...
## [#](https://vue3js.cn/interview/vue/404.html#一、如何部署)一、如何部署

前后端分离开发模式下，前后端是独立布署的，前端只需要将最后的构建物上传至目标服务器的`web`容器指定的静态目录下即可

我们知道`vue`项目在构建后，是生成一系列的静态文件

![img](https://imgkr2.cn-bj.ufileos.com/b9d13e56-f859-4b4b-a9da-a703a34c2f5d.png?UCloudPublicKey=TOKEN_8d8b72be-579a-4e83-bfd0-5f6ce1546f13&Signature=m1qDXRSFHrfXlnAtAlVhjoLKP70%253D&Expires=1609927181)
...
## [#](https://vue3js.cn/interview/vue/404.html#二、404问题)二、404问题
...
### [#](https://vue3js.cn/interview/vue/404.html#为什么history模式下有问题)为什么history模式下有问题
...
### [#](https://vue3js.cn/interview/vue/404.html#为什么hash模式下没有问题)为什么hash模式下没有问题
...
## [#](https://vue3js.cn/interview/vue/404.html#解决方案)解决方案
