...
![img](https://static.vue-js.com/fa1d5720-26ac-11ec-8e64-91fdec0f05a1.png)

## [#](https://vue3js.cn/interview/algorithm/mergeSort.html#一、是什么)一、是什么
...
![img](https://static.vue-js.com/05f14b60-26ad-11ec-a752-75723a64e8f5.png)

归并合过程中，每次得到的新的子表本身有序，所以最终得到有序表

上述分成两部分，则称为二路归并，如果分成三个部分则称为三路归并，以此类推

## [#](https://vue3js.cn/interview/algorithm/mergeSort.html#二、如何实现)二、如何实现
...
## [#](https://vue3js.cn/interview/algorithm/mergeSort.html#三、应用场景)三、应用场景
