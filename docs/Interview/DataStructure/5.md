...
![img](https://static.vue-js.com/d6638dd0-1c76-11ec-8e64-91fdec0f05a1.png)

## [#](https://vue3js.cn/interview/algorithm/Linked List.html#一、是什么)一、是什么

链表（Linked List）是一种物理存储单元上非连续、非顺序的存储结构，数据元素的逻辑顺序是通过链表中的指针链接次序实现的，由一系列结点（链表中每一个元素称为结点）组成

每个结点包括两个部分：一个是存储数据元素的数据域，另一个是存储下一个结点地址的指针域

![img](https://static.vue-js.com/e4e93490-1c76-11ec-8e64-91fdec0f05a1.png)
...
## [#](https://vue3js.cn/interview/algorithm/Linked List.html#二、操作)二、操作
...
### [#](https://vue3js.cn/interview/algorithm/Linked List.html#遍历)遍历
...
### [#](https://vue3js.cn/interview/algorithm/Linked List.html#插入)插入

向链表中间插入一个元素，可以如下图所示：

![img](https://static.vue-js.com/f5fe5fd0-1c76-11ec-8e64-91fdec0f05a1.png)
...
### [#](https://vue3js.cn/interview/algorithm/Linked List.html#删除)删除

向链表任意位置删除节点，如下图操作：

![img](https://static.vue-js.com/0160cd90-1c77-11ec-a752-75723a64e8f5.png)
...
## [#](https://vue3js.cn/interview/algorithm/Linked List.html#三、应用场景)三、应用场景
