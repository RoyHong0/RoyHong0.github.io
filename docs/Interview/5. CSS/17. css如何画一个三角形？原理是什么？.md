...
![img](https://static.vue-js.com/bd310120-a279-11eb-85f6-6fac77c0c9b3.png)

## [#](https://vue3js.cn/interview/css/triangle.html#一、前言)一、前言

在前端开发的时候，我们有时候会需要用到一个三角形的形状，比如地址选择或者播放器里面播放按钮

![img](https://static.vue-js.com/d6d8ff60-a279-11eb-85f6-6fac77c0c9b3.png)

通常情况下，我们会使用图片或者`svg`去完成三角形效果图，但如果单纯使用`css`如何完成一个三角形呢？

实现过程似乎也并不困难，通过边框就可完成

## [#](https://vue3js.cn/interview/css/triangle.html#二、实现过程)二、实现过程
...
## [#](https://vue3js.cn/interview/css/triangle.html#三、原理分析)三、原理分析
...
## [#](https://vue3js.cn/interview/css/triangle.html#参考文献)参考文献
