...
![img](https://static.vue-js.com/c3d68290-9511-11eb-85f6-6fac77c0c9b3.png)

## [#](https://vue3js.cn/interview/css/BFC.html#一、是什么)一、是什么
...
## [#](https://vue3js.cn/interview/css/BFC.html#二、触发条件)二、触发条件
...
## [#](https://vue3js.cn/interview/css/BFC.html#三、应用场景)三、应用场景

利用`BFC`的特性，我们将`BFC`应用在以下场景：

#### [#](https://vue3js.cn/interview/css/BFC.html#防止margin重叠-塌陷)防止margin重叠（塌陷）
...
#### [#](https://vue3js.cn/interview/css/BFC.html#清除内部浮动)清除内部浮动
...
#### [#](https://vue3js.cn/interview/css/BFC.html#自适应多栏布局)自适应多栏布局
...
### [#](https://vue3js.cn/interview/css/BFC.html#小结)小结

可以看到上面几个案例，都体现了`BFC`实际就是页面一个独立的容器，里面的子元素不影响外面的元素

## [#](https://vue3js.cn/interview/css/BFC.html#参考文献)参考文献
