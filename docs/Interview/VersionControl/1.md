...
![img](https://static.vue-js.com/f0e8a2d0-f5ac-11eb-ab90-d9ae814b240d.png)

## [#](https://vue3js.cn/interview/git/Version control.html#一、是什么)一、是什么
...
## [#](https://vue3js.cn/interview/git/Version control.html#二、有哪些)二、有哪些
...
### [#](https://vue3js.cn/interview/git/Version control.html#本地版本控制系统)本地版本控制系统

结构如下图所示：

![img](https://static.vue-js.com/c545ded0-f5ad-11eb-ab90-d9ae814b240d.png)
...
### [#](https://vue3js.cn/interview/git/Version control.html#集中式版本控制系统)集中式版本控制系统

结构如下图所示：

![img](https://static.vue-js.com/8b4b3040-f5ad-11eb-85f6-6fac77c0c9b3.png)
...
### [#](https://vue3js.cn/interview/git/Version control.html#svn)SVN

`TortoiseSVN`是一款非常易于使用的跨平台的 版本控制/版本控制/源代码控制软件

### [#](https://vue3js.cn/interview/git/Version control.html#cvs)CVS
...
#### [#](https://vue3js.cn/interview/git/Version control.html#分布式版本控制系统)分布式版本控制系统

结构如下图：

![img](https://static.vue-js.com/4301a260-f5ad-11eb-85f6-6fac77c0c9b3.png)
...
### [#](https://vue3js.cn/interview/git/Version control.html#git)Git
...
### [#](https://vue3js.cn/interview/git/Version control.html#hg)HG

`Mercurial`是一个免费的分布式源代码管理工具。它可以有效地处理任何规模的项目，并提供简单直观的界面

`Mercurial`是一种轻量级分布式版本控制系统，采用 `Python`语言实现，易于学习和使用，扩展性强

## [#](https://vue3js.cn/interview/git/Version control.html#三、总结)三、总结
