...
![img](https://static.vue-js.com/8aeccc40-fdb3-11eb-bc6f-3f06e1491664.png)

## [#](https://vue3js.cn/interview/git/conflict.html#一、是什么)一、是什么
...
## [#](https://vue3js.cn/interview/git/conflict.html#二、分析)二、分析

在本地主分值`master`创建一个`a.txt`文件，文件起始位置写上`master commit`，如下：

![img](https://static.vue-js.com/959ade20-fdb3-11eb-991d-334fd31f0201.png)
...
![img](https://static.vue-js.com/a05488c0-fdb3-11eb-991d-334fd31f0201.png)

这种情况下，无法执行快速合并，只能试图把各自的修改合并起来，但这种合并就可能会有冲突

现在通过`git merge featurel`进行分支合并，如下所示：

![img](https://static.vue-js.com/b0991d90-fdb3-11eb-bc6f-3f06e1491664.png)

从冲突信息可以看到，`a.txt`发生冲突，必须手动解决冲突之后再提交

而`git status`同样可以告知我们冲突的文件：

![img](https://static.vue-js.com/c5823430-fdb3-11eb-991d-334fd31f0201.png)

打开`a.txt`文件，可以看到如下内容：

![img](https://static.vue-js.com/ce7a0a90-fdb3-11eb-bc6f-3f06e1491664.png)
...
![img](https://static.vue-js.com/d7421e60-fdb3-11eb-bc6f-3f06e1491664.png)

使用`git log`命令可以看到合并的信息：

![img](https://static.vue-js.com/e0dfd1b0-fdb3-11eb-991d-334fd31f0201.png)

## [#](https://vue3js.cn/interview/git/conflict.html#三、总结)三、总结
