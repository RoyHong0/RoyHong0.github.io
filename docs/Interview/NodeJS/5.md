...
![img](https://static.vue-js.com/176d02b0-c69c-11eb-ab90-d9ae814b240d.png)

## [#](https://vue3js.cn/interview/NodeJS/Buffer.html#一、是什么)一、是什么
...
## [#](https://vue3js.cn/interview/NodeJS/Buffer.html#二、使用方法)二、使用方法
...
### [#](https://vue3js.cn/interview/NodeJS/Buffer.html#buffer-from)Buffer.from()
...
### [#](https://vue3js.cn/interview/NodeJS/Buffer.html#buffer-alloc)Buffer.alloc()
...
## [#](https://vue3js.cn/interview/NodeJS/Buffer.html#三、应用场景)三、应用场景
...
### [#](https://vue3js.cn/interview/NodeJS/Buffer.html#i-o操作)I/O操作
...
### [#](https://vue3js.cn/interview/NodeJS/Buffer.html#加解密)加解密

在一些加解密算法中会遇到使用 `Buffer`，例如 `crypto.createCipheriv` 的第二个参数 `key` 为 `string` 或 `Buffer` 类型

### [#](https://vue3js.cn/interview/NodeJS/Buffer.html#zlib-js)zlib.js
