...
![img](https://static.vue-js.com/4f7866b0-c2b2-11eb-85f6-6fac77c0c9b3.png)

## [#](https://vue3js.cn/interview/NodeJS/process.html#一、是什么)一、是什么
...
## [#](https://vue3js.cn/interview/NodeJS/process.html#二、属性与方法)二、属性与方法
...
### [#](https://vue3js.cn/interview/NodeJS/process.html#process-cwd)process.cwd()

返回当前 `Node`进程执行的目录

一个`Node` 模块 `A` 通过 NPM 发布，项目 `B` 中使用了模块 `A`。在 `A` 中需要操作 `B` 项目下的文件时，就可以用 `process.cwd()` 来获取 `B` 项目的路径

### [#](https://vue3js.cn/interview/NodeJS/process.html#process-argv)process.argv
...
### [#](https://vue3js.cn/interview/NodeJS/process.html#process-env)process.env
...
### [#](https://vue3js.cn/interview/NodeJS/process.html#process-nexttick)process.nextTick()
