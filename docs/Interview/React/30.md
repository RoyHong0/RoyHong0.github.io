...
![img](https://static.vue-js.com/a9e83b00-f270-11eb-ab90-d9ae814b240d.png)

## [#](https://vue3js.cn/interview/React/Improve performance.html#一、是什么)一、是什么
...
## [#](https://vue3js.cn/interview/React/Improve performance.html#二、如何做)二、如何做

在[React中如何避免不必要的render (opens new window)](https://mp.weixin.qq.com/s/h4NX4Plr6TCjoIhlawiJTg)中，我们了解到如何避免不必要的`render`来应付上面的问题，主要手段是通过`shouldComponentUpdate`、`PureComponent`、`React.memo`，这三种形式这里就不再复述
...
#### [#](https://vue3js.cn/interview/React/Improve performance.html#使用-react-fragments-避免额外标记)使用 React Fragments 避免额外标记
...
### [#](https://vue3js.cn/interview/React/Improve performance.html#事件绑定方式)事件绑定方式
...
### [#](https://vue3js.cn/interview/React/Improve performance.html#使用-immutable)使用 Immutable
...
### [#](https://vue3js.cn/interview/React/Improve performance.html#服务端渲染)服务端渲染
...
### [#](https://vue3js.cn/interview/React/Improve performance.html#其他)其他

除此之外，还存在的优化手段有组件拆分、合理使用`hooks`等性能优化手段...

### [#](https://vue3js.cn/interview/React/Improve performance.html#三、总结)三、总结
