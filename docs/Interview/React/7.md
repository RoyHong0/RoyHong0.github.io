...
![img](https://static.vue-js.com/f054f080-d86f-11eb-ab90-d9ae814b240d.png)

## [#](https://vue3js.cn/interview/React/SyntheticEvent.html#一、是什么)一、是什么

`React`基于浏览器的事件机制自身实现了一套事件机制，包括事件注册、事件的合成、事件冒泡、事件派发等

在`React`中这套事件机制被称之为合成事件

#### [#](https://vue3js.cn/interview/React/SyntheticEvent.html#合成事件-syntheticevent)合成事件（SyntheticEvent）
...
## [#](https://vue3js.cn/interview/React/SyntheticEvent.html#二、执行顺序)二、执行顺序
...
## [#](https://vue3js.cn/interview/React/SyntheticEvent.html#三、总结)三、总结
