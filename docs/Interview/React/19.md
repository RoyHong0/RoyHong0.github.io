...
![img](https://static.vue-js.com/52394be0-e2a5-11eb-ab90-d9ae814b240d.png)

## [#](https://vue3js.cn/interview/React/redux.html#一、是什么)一、是什么
...
## [#](https://vue3js.cn/interview/React/redux.html#二、工作原理)二、工作原理
...
## [#](https://vue3js.cn/interview/React/redux.html#三、如何使用)三、如何使用
...
### [#](https://vue3js.cn/interview/React/redux.html#小结)小结

- createStore可以帮助创建 store
- store.dispatch 帮助派发 action , action 会传递给 store
- store.getState 这个方法可以帮助获取 store 里边所有的数据内容
- store.subscrible 方法订阅 store 的改变，只要 store 发生改变， store.subscrible 这个函数接收的这个回调函数就会被执