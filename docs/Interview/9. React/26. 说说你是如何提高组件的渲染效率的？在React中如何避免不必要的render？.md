...
![img](https://static.vue-js.com/de2d7e20-ecf8-11eb-85f6-6fac77c0c9b3.png)

## [#](https://vue3js.cn/interview/React/improve_render.html#一、是什么)一、是什么
...
## [#](https://vue3js.cn/interview/React/improve_render.html#二、如何做)二、如何做
...
### [#](https://vue3js.cn/interview/React/improve_render.html#shouldcomponentupdate)shouldComponentUpdate

通过`shouldComponentUpdate`生命周期函数来比对 `state`和 `props`，确定是否要重新渲染

默认情况下返回`true`表示重新渲染，如果不希望组件重新渲染，返回 `false` 即可

### [#](https://vue3js.cn/interview/React/improve_render.html#purecomponent)PureComponent
...
### [#](https://vue3js.cn/interview/React/improve_render.html#react-memo)React.memo
...
## [#](https://vue3js.cn/interview/React/improve_render.html#三、总结)三、总结
