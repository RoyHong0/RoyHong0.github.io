...
![img](https://static.vue-js.com/12990fd0-df2f-11eb-ab90-d9ae814b240d.png)

## [#](https://vue3js.cn/interview/React/controlled_Uncontrolled.html#一、受控组件)一、受控组件
...
## [#](https://vue3js.cn/interview/React/controlled_Uncontrolled.html#二、非受控组件)二、非受控组件
...
关于`refs`的详情使用可以参考[之前文章(opens new window)](https://mp.weixin.qq.com/s/ZBKWcslVBi0IKQgz7lYzbA)

## [#](https://vue3js.cn/interview/React/controlled_Uncontrolled.html#三、应用场景)三、应用场景
